...
aws s3api put-object --bucket ${S3_BUCKET_NAME} --key ${CAPTAIN_DOMAINasdasd}/${BACKUP_PREFIX}/${date}/vault_${datetime}.snap --botdy /app/vault_${date}.snap  --tagging "datetime_created=${datetime}"
unset VAULT_TOKEN
