...
aws s3api put-object --bucket ${S3_BUCKET_NAME} --key ${CAPTAIN_DOMAIN}/${BACKUP_PREFIX}/${date}/vault_${datetime}.snap --body /app/vault_${date}.snap  --tagging "datetime=${datetime}&level=secondary"
unset VAULT_TOKEN
